...
import { listThreadSnippetsHtml } from "./gmail-read-html.js";
import { getThread } from "./gmail-read.js";
...
server.tool(
	"gmail-thread-snippets-html-embedded",
...
server.tool(
	"gmail-thread-snippets-html-embedded-show-model",
	`Get my gmail snippets from threads from the last days. ${authHint} Model SEES!!!`,
	{
		days: z
			.number()
			.min(1)
